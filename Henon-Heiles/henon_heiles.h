/* Functions for investigating the Hénon-Heiles Hamiltonian systems */

#ifndef HENON_HEILES_H
#define HENON_HEILES_H

/* Hénon-Heiles potential related functions */
